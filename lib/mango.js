...
Mango.prototype.build = function(tasks, callback) {
	...
	this._registerGulpTasks(gulp, tasks)
...
Mango.prototype._registerGulpTasks = function(gulp, whitelist) {
	...
	if(whitelist && whitelist.length && whitelist.indexOf('buildstamp') == -1) {
